...
async function getAccount(type) {
  ...
  if (type == "standby") {
    ...
    document.getElementById("operationalAccountField").value =
      my_wallet.address;
    document.getElementById("operationalPubKeyField").value =
      my_wallet.publicKey;
    document.getElementById("operationalPrivKeyField").value =
...
async function getAccountsFromSeeds() {
  ...
  document.getElementById("standbyPubKeyField").value =
    standby_wallet.publicKey;
  document.getElementById("standbyPrivKeyField").value =
    standby_wallet.privateKey;
  ...
  document.getElementById("operationalAccountField").value =
    operational_wallet.address;
  document.getElementById("operationalPubKeyField").value =
    operational_wallet.publicKey;
  document.getElementById("operationalPrivKeyField").value =
    operational_wallet.privateKey;
  document.getElementById("operationalSeedField").value =
    operational_wallet.seed;
  document.getElementById("operationalBalanceField").value =
